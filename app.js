...
var incompleteTaskHolder = document.querySelector(".incomplete-list");//ul of #incomplete-list
...
var editTask = function () {
    ...
    var containsClass = listItem.classList.contains("item_active");
    ...
    listItem.classList.toggle("item_active");
};
